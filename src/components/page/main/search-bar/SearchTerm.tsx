...
export default class SearchTerm<OptionType=string> extends React.Component<{text:string}&({type:"string",value:string,onChange:(data:string)=>void}|{type:"dropdown",value:OptionData<OptionType>,options:OptionData<OptionType>,onChange:(data:OptionData<OptionType>)=>void})> {
